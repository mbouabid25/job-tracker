...
Also EXCLUDE — these are NOT job applications:
- LinkedIn connection requests, invitations, or acceptances ("wants to connect", "accepted your invitation", "You and X are now connected")
- LinkedIn notifications about profile views, endorsements, follows, reactions, or likes
- LinkedIn "People you may know", "Jobs you may be interested in", or digest/newsletter emails
- Generic recruiter cold outreach that has no evidence the person applied or responded
  (a cold InMail from a stranger with no reply or application confirmation is NOT tracked)
