...
- company and position are REQUIRED. If the position title cannot be determined from the email, use "Unknown Position" rather than omitting it or using null. Same for company: use "Unknown Company" if truly indeterminate.
